...
export default function Header() {
	...
	return (
		<div
			className='w-full h-24 fixed backdrop-blur-md
 bg-white bg-opacity-5 2xl:px-20 lg:px-16 md:px-10 px-10'
		>
			<div className='w-full h-full flex items-center justify-between relative'>
				...
				<div className='flex items-center lg:gap-12 md:gap-8 gap-4 z-20'>
					...
					<div>
						<LanguageSelect setTranslations={setTranslations} translations={translations} setSelectedLanguage={setSelectedLanguage} selectedLanguage={selectedLanguage}/>
					</div>
				</div>
			</div>
		</div>
