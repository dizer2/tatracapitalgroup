...
// async function seedMainInfo() {
//   await prisma.mainInfo.create({
//     data: {
//       logo: "/images/assets/landing/logo.svg",
//       phone: "1234567890",
//       email: "contact@company.com",
//       socialMedia: [
//         { link: "https://facebook.com/company", icon: "/images/assets/landing/socials/linkedin.svg" },
//         { link: "https://twitter.com/company", icon: "/images/assets/landing/socials/x.svg" },
//       ],
//       translations: [
//         {
//           lang: "en",
...
//   console.log("MainInfo seed data added.");
// }
...
async function seedWorkSection() {
  const teamSection = [
    {
      translations: [
          {
            lang: "en",
            title: "Who We Are",
            description: "Tatra Capital Group is a multinational holding company founded by a group of international investors from the US, UK, and the Middle East. With a strong presence in Slovakia, we partner with and develop businesses in key industries—Food, Manufacturing, and Real Estate—that are essential for long-term economic development in Central Europe. Our approach combines global business expertise with deep local market knowledge, ensuring that every business within our portfolio operates efficiently, scales sustainably, and contributes to regional economic growth. We focus on long-term business development and sustainable expansion.",
            buttonCardText: "Learn more",
            buttonApplyText: "Apply now",
          },
          {
            lang: "sk",
            title: "Kto sme",
            description: " 55 Tatra Capital Group is a multinational holding company founded by a group of international investors from the US, UK, and the Middle East. With a strong presence in Slovakia, we partner with and develop businesses in key industries—Food, Manufacturing, and Real Estate—that are essential for long-term economic development in Central Europe. Our approach combines global business expertise with deep local market knowledge, ensuring that every business within our portfolio operates efficiently, scales sustainably, and contributes to regional economic growth. We focus on long-term business development and sustainable expansion.",
            buttonCardText: "Zisti viac",
            buttonApplyText: "Aplikovať teraz",
          },
        ],
    },
  ];
  ...
  for (const section of teamSection) {
    await prisma.workPostSection.create({
      data: section,
    });
  }
  console.log("TeamSection seed data added.");
